    ...
    return (
        <div style={{ display: "flex", justifyContent: 'center', textAlign: 'center', marginTop: '5rem', marginLeft: 'auto', marginRight: 'auto' }}>
            <Card sx={{ maxWidth: "60%" }}>
                ...
                />
                <HistoryIcon style={{ height: 100, width: 100 }} />
                <CardContent>
                    <Typography style={{ marginBottom: "2rem", marginTop: "2rem" }} variant="body2" color="text.primary">
                        All'interno di questa sezione, potrai visualizzare lo storico dei movimenti dei prodotti all'interno del magazzino
                    </Typography>
                    <Typography variant="body2" color="text.primary">
                        Potrai visualizzare le transazioni per dipendente o per prodotto
                    </Typography>
                </CardContent>
                <CardActions style={{ display: "flex", justifyContent: 'center', textAlign: 'center' }}>
                    <IconButton>
                        <Button variant="outlined" style={{ color: 'white', backgroundColor: 'green' }}><Link style={{ color: 'white' }} to={"/history"}>Vai allo storico!</Link></Button>
                    </IconButton>
                </CardActions>
            </Card>
        </div >
